...
import { ShoppingCart, Package, Tags, Barcode, BarChart3, Store, Smartphone, Download, X, Settings, Users, Calculator, Wallet } from 'lucide-react';
...
type Page = 'dashboard' | 'pos' | 'products' | 'categories' | 'barcode' | 'reports' | 'customers' | 'cash' | 'staff' | 'earnings' | 'settings';
...
const navItems: { key: Page; label: string; icon: typeof ShoppingCart }[] = [
  ...
  { key: 'earnings', label: 'Kazancım', icon: Wallet },
...
function canAccess(role: Staff['role'] | null, page: Page) {
  ...
  return page === 'pos' || page === 'customers' || page === 'earnings';
}
