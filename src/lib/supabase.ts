...
export type Staff = { id:string; name:string; pin:string|null; pin_hash?:string|null; role:'admin'|'manager'|'cashier'; active:boolean; earning_rate:number; created_at:string };
