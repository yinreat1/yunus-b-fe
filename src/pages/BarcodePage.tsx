...
import { Search, Printer, X, Plus, Barcode as BarcodeIcon } from 'lucide-react';
...
const LAYOUTS: Record<LayoutType, LayoutConfig> = {
  small: {
    ...
    nameSize: 9, priceSize: 21, barcodeHeight: 15, barcodeWidth: 1.2, barcodeFontSize: 7, dateSize: 6,
  },
  medium: {
    variant: 'medium', cols: 3, rows: 7, label: '100 x 38 mm', perSheet: 21,
    width: '100mm', height: '38mm',
    nameSize: 10, priceSize: 27, barcodeHeight: 18, barcodeWidth: 1.5, barcodeFontSize: 8, dateSize: 6,
  },
  large: {
    variant: 'large', cols: 3, rows: 5, label: '100 x 50 mm', perSheet: 15,
    width: '100mm', height: '50mm',
    nameSize: 12, priceSize: 34, barcodeHeight: 25, barcodeWidth: 1.8, barcodeFontSize: 9, dateSize: 7,
  },
};
