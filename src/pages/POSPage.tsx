          ...
          onComplete={async (method, paid, customerName, customerId) => {
            ...
            try {
              ...
              if (sale) {
                ...
                alert('Satış kaydedilemedi. İşlem geri alındı; aynı satış tekrar eklenmedi.');
              }
            } finally {
...
function PaymentModal({
  ...
  onClose: () => void;
  processing: boolean;
  onComplete: (method: PaymentMethod, paid: number, customerName?: string, customerId?: string) => Promise<void>;
}) {
