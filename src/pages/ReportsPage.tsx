...
import { getShopExpenses, getSaleItems, moveSaleToTrash, refundSale, partialReturn, useCashSessions, useDeletedSales, useProducts, useSales, restoreSaleFromTrash, permanentlyDeleteSale } from '@/lib/hooks';
...
export default function ReportsPage() {
  ...
  const filteredSales = useMemo(() => {
    const activeSales = sales.filter((s) => !s.refunded_at && !String(s.deleted_reason || '').startsWith('İADE|'));
